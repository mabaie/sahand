...
export default function ManagerMenu(props) {
  return (
    <List>
      <MenuItem button selected={props.path==="/sahand/manager/dashboard/"}>
        <ListItem button component={Link} to="/sahand/manager/dashboard/">
          <ListItemIcon>
      ...
      <MenuItem button selected={props.path==="/sahand/manager/dashboard/student-register/"}>
        <ListItem
          button
          component={Link}
        ...
        >
          <ListItemIcon>
            <PersonAdd nativeColor="rgba(0, 0, 0, 0.54)" />
          </ListItemIcon>
          <ListItemText primary="ثبت نام" />
        </ListItem>
      </MenuItem>

      <MenuItem button selected={props.path==="/sahand/manager/dashboard/teacher-register/"}>
        <ListItem
          button
          component={Link}
        ...
        >
          <ListItemIcon>
            <SvgIcon nativeColor="rgba(0, 0, 0, 0.54)" viewBox="0 0 35 30">
              <g>
                <g>
        ...
        5.492,29.105 5.492,29.275 5.492,30.85 7.18,30.85 7.194,30.602 8.718,30.85 10.023,30.85 10.023,29.438 8.489,29.105 		"
          ...
          <ListItemText primary="لیست معلمان" />
        </ListItem>
      </MenuItem>

      <MenuItem button selected={props.path==="/sahand/manager/dashboard/class-register/"}>
        <ListItem
          button
          component={Link}
        ...
        >
          <ListItemIcon>
            <SvgIcon nativeColor="rgba(0, 0, 0, 0.54)" viewBox="0 0 50 50" width={24} height={24}>
          ...
          <ListItemText primary="لیست کلاس‌ها " />
        </ListItem>
      </MenuItem>

      <MenuItem button selected={props.path==="/sahand/manager/dashboard/course-register/"}>
      <ListItem
        button
        component={Link}
      ...
      >
        <ListItemIcon>
          <SvgIcon nativeColor="rgba(0, 0, 0, 0.54)" viewBox="0 0 500 500">
            <path
        ...
        <ListItemText primary="لیست دروس" />
      </ListItem>
      </MenuItem>

      <MenuItem button selected={props.path==="/sahand/manager/dashboard/class-work/"}>
        <ListItem
          button
          component={Link}
        ...
        >
          <ListItemIcon>
            <DailyWork nativeColor="rgba(0, 0, 0, 0.54)"/>
          </ListItemIcon>
          <ListItemText primary="فعالیت‌های کلاسی" />
        </ListItem>
      </MenuItem>

      <MenuItem button selected={props.path==="/sahand/manager/dashboard/news/"}>
        <ListItem button component={Link} to="/sahand/manager/dashboard/news/">
          <ListItemIcon>
      ...
      <MenuItem button selected={props.path==="/sahand/manager/dashboard/magazine/"}>
        <ListItem button component={Link} to="/sahand/manager/dashboard/magazine/">
          <ListItemIcon>
            <SvgIcon nativeColor="rgba(0, 0, 0, 0.54)"
            viewBox="0 0 24 24">
      ...
      <MenuItem button selected={props.path==="/sahand/manager/dashboard/report/"}>
        <ListItem button component={Link} to="/sahand/manager/dashboard/report/">
          <ListItemIcon>
      ...
      <MenuItem button selected={props.path==="/sahand/manager/dashboard/calendar/"}>
        <ListItem button component={Link} to="/sahand/manager/dashboard/calendar/">
          <ListItemIcon>
      ...
      <MenuItem button selected={props.path==="/sahand/manager/dashboard/gallery/"}>
        <ListItem button component={Link} to="/sahand/manager/dashboard/gallery/">
          <ListItemIcon>
      ...
      <MenuItem button selected={props.path==="/sahand/manager/dashboard/encourage/"}>
        <ListItem
          button
          component={Link}
        ...
        >
          <ListItemIcon>
            <SvgIcon viewBox="0 0 1000 1000" nativeColor="rgba(0, 0, 0, 0.54)">
      ...
      <MenuItem button selected={props.path==="/sahand/manager/dashboard/appointment/"}>
        <ListItem
          button
          component={Link}
        ...
        >
          <ListItemIcon>
            <Appointment_icon nativeColor="rgba(0, 0, 0, 0.54)"/>
          </ListItemIcon>
          <ListItemText primary="قرار ملاقات" />
        </ListItem>
      </MenuItem>
      <MenuItem button selected={props.path==="/sahand/manager/dashboard/home-activity/"}>
        <ListItem
          button
          component={Link}
      ...
      <MenuItem button selected={props.path==="/sahand/manager/dashboard/messages/"}>
        <ListItem button component={Link} to='/sahand/manager/dashboard/messages/'>
          <ListItemIcon>
      ...
      <MenuItem button selected={props.path==="/sahand/manager/dashboard/settings/"}>
        <ListItem button component={Link} to="/sahand/manager/dashboard/settings/">
          <ListItemIcon>
            <Settings nativeColor="rgba(0, 0, 0, 0.54)"/>
          </ListItemIcon>
          <ListItemText primary="تنظیمات" />
        </ListItem>
      </MenuItem>

      <MenuItem button selected={props.path==="/sahand/manager/dashboard/evaluation/"}>
        <ListItem button component={Link} to="/sahand/manager/dashboard/evaluation/">
          <ListItemIcon>
          <SvgIcon nativeColor="rgba(0, 0, 0, 0.54)" xmlns="http://www.w3.org/2000/svg" viewBox="-26 0 512 512">
