...
export default function ParentMenu(props) {
  ...
  return (
    <List>
      <MenuItem button selected={props.path==="/sahand/parent/dashboard/"}>
        <ListItem button component={Link} to="/sahand/parent/dashboard/">
          <ListItemIcon>
            <Home nativeColor="rgba(0, 0, 0, 0.54)"/>
          </ListItemIcon>
          <ListItemText primary="خانه" />
        </ListItem>
      </MenuItem>
      <MenuItem button selected={props.path==="/sahand/parent/dashboard/assignments/"}>
        <ListItem button  component={Link} to="/sahand/parent/dashboard/assignments/">
          <ListItemIcon>
          <Assignment nativeColor="rgba(0, 0, 0, 0.54)" />
          </ListItemIcon>
          <ListItemText primary="تکالیف" />
        </ListItem>
      </MenuItem>
      <MenuItem button selected={props.path==="/sahand/parent/dashboard/attendanceReport/"}>
        <ListItem button component={Link} to="/sahand/parent/dashboard/attendanceReport/">
          <ListItemIcon>
          <HowToReg nativeColor="rgba(0, 0, 0, 0.54)"/>
          </ListItemIcon>
          <ListItemText primary="حضور در مدرسه" />
        </ListItem>
      </MenuItem>

      <MenuItem button selected={props.path==='/sahand/parent/dashboard/homeActivity/'}>
        <ListItem button component={Link} to='/sahand/parent/dashboard/homeActivity/'>
          <ListItemIcon>
          <HomeActivity nativeColor="rgba(0, 0, 0, 0.54)" />
          </ListItemIcon>
          <ListItemText primary="فعالیت در خانه" />
        </ListItem>
      </MenuItem>

      <MenuItem button selected={props.path==='/sahand/parent/dashboard/addAppointment/'}>
        <ListItem button component={Link} to='/sahand/parent/dashboard/addAppointment/'>
          <ListItemIcon>
          <SvgIcon nativeColor="rgba(0, 0, 0, 0.54)" height="512pt" viewBox="0 0 512 512" width="512pt" xmlns="http://www.w3.org/2000/svg">
      ...
      <MenuItem button selected={props.path==='/sahand/parent/dashboard/news/'}>
        <ListItem button component={Link} to='/sahand/parent/dashboard/news/'>
          ...
          <ListItemText primary="اخبار مدرسه" />
        </ListItem>
      </MenuItem>

      <MenuItem button selected={props.path==='/sahand/parent/dashboard/gallery/'}>
        <ListItem button component={Link} to='/sahand/parent/dashboard/gallery/'>
          <ListItemIcon>
          <Gallery nativeColor="rgba(0, 0, 0, 0.54)" />
          </ListItemIcon>
          <ListItemText primary="گالری" />
        </ListItem>
      </MenuItem>
      <MenuItem button selected={props.path==='/sahand/parent/dashboard/messages/'}>
        <ListItem button component={Link} to='/sahand/parent/dashboard/messages/'>
          <ListItemIcon>
          <Message nativeColor="rgba(0, 0, 0, 0.54)"/>
          </ListItemIcon>
          <ListItemText primary="پیام‌ها" />
        </ListItem>
      </MenuItem>
      <MenuItem button selected={props.path==='/sahand/parent/dashboard/studentTimeTable/'}>
        <ListItem button component={Link} to='/sahand/parent/dashboard/studentTimeTable/'>
          <ListItemIcon>
          <AvTimer nativeColor="rgba(0, 0, 0, 0.54)"/>
          </ListItemIcon>
          <ListItemText primary="برنامه کلاسی" />
        </ListItem>
      </MenuItem>
      <MenuItem button selected={props.path==='/sahand/parent/dashboard/calendar/'}>
        <ListItem button component={Link} to='/sahand/parent/dashboard/calendar/'>
          <ListItemIcon>
          <Calendar nativeColor="rgba(0, 0, 0, 0.54)"/>
          </ListItemIcon>
          <ListItemText primary="تقویم اجرایی" />
        </ListItem> 
      </MenuItem>
      <MenuItem button selected={props.path==='/sahand/parent/dashboard/report/'}>
        <ListItem button component={Link} to='/sahand/parent/dashboard/report/'>
          <ListItemIcon>
          <Report nativeColor="rgba(0, 0, 0, 0.54)"/>
          </ListItemIcon>
          <ListItemText primary="گزارش فعالیت" />
        </ListItem>
      </MenuItem>
      <MenuItem button selected={props.path==='/sahand/parent/dashboard/about/'}>
        <ListItem button component={Link} to='/sahand/parent/dashboard/about/'>
          <ListItemIcon>
          <School nativeColor="rgba(0, 0, 0, 0.54)"/>
          </ListItemIcon>
          <ListItemText primary="درباره مدرسه" />
        </ListItem>
      </MenuItem>

      <MenuItem button selected={props.path==='/sahand/parent/dashboard/magazine/'}>
        <ListItem button component={Link} to='/sahand/parent/dashboard/magazine/'>
          <ListItemIcon>
          <SvgIcon nativeColor="rgba(0, 0, 0, 0.54)" viewBox="0 0 24 24">
      ...
      <ListItem button component={LogoutWrapper}>
        <ListItemIcon>
          <ExitToApp nativeColor="rgba(0, 0, 0, 0.54)"/>
        </ListItemIcon>
