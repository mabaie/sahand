                    ...
                    <GridList spacing={16} cols={this.getGridListCols()} className={classes.gridList}>
                        ...
                        <GridListTile >
                            <ButtonBase
                                ...
                                component={Link}
                                to="/sahand/parent/dashboard/assignments">
...
تکالیف
                        ...
                        <GridListTile >
                            <ButtonBase
                                ...
                                title="حضور و غیاب"
                                component={Link}
                                to="/sahand/parent/dashboard/attendanceReport">
...
حضور و غیاب
                        ...
                        <GridListTile >
                            <ButtonBase
                                ...
                                className={classes.buttonBase}
                                component={Link}
                                to="/sahand/parent/dashboard/homeActivity">
...
فعالیت در خانه
                        ...
                        <GridListTile >
                            <ButtonBase
                                ...
                                className={classes.buttonBase}
                                component={Link}
                                to="/sahand/parent/dashboard/addAppointment">
...
درخواست ملاقات
                        ...
                        {/* <GridListTile >
                            <ButtonBase
                                ...
                                title="تشویق‌ها"
                                component={Link}
                                to="/sahand/parent/dashboard/encourages">
                                <SvgIcon
...
تشویق‌ها
                        ...
                        <GridListTile >
                            <ButtonBase
                                ...
                                title="اخبار مدرسه"
                                component={Link}
                                to="/sahand/parent/dashboard/news">
...
اخبار مدرسه
                        ...
                        <GridListTile >
                            <ButtonBase
                                ...
                                title="گالری"
                                component={Link}
                                to="/sahand/parent/dashboard/gallery">
...
گالری
                        ...
                        <GridListTile >
                            <ButtonBase
                                ...
                                title="پیام‌ها"
                                component={Link}
                                to="/sahand/parent/dashboard/messages">
...
پیام‌ها
                        ...
                        <GridListTile >
                            <ButtonBase
                                ...
                                title="برنامه کلاسی"
                                component={Link}
                                to="/sahand/parent/dashboard/studentTimeTable">
...
برنامه کلاسی
                        ...
                        <GridListTile >
                            <ButtonBase
                                ...
                                title="تقویم اجرایی"
                                component={Link}
                                to="/sahand/parent/dashboard/calendar">
...
تقویم اجرایی
                        ...
                        <GridListTile >
                            <ButtonBase
                                ...
                                title="گزارش‌ها"
                                component={Link}
                                to="/sahand/parent/dashboard/report">
...
گزارش‌ها
                        ...
                        <GridListTile >
                            <ButtonBase
                                ...
                                title="درباره مدرسه"
                                component={Link}
                                to="/sahand/parent/dashboard/about">
...
درباره مدرسه
                        ...
                        <GridListTile >
                            <ButtonBase
                                ...
                                title="انتشارات"
                                component={Link}
                                to="/sahand/parent/dashboard/magazine">
