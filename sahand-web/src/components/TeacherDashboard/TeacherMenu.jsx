...
export default function ParentMenu(props) {
  return (
    <List>
      <ListItem button component={Link} to="/sahand/teacher/dashboard">
        <ListItemIcon>
      ...
      <ListItem button component={Link} to="/sahand/teacher/dashboard/students">
        <ListItemIcon>
        ...
        <ListItemText primary="دانش‌آموزان" />
      </ListItem>
      <ListItem button component={Link} to="/sahand/teacher/dashboard/grade">
        <ListItemIcon>
          
<SvgIcon nativeColor="rgba(0, 0, 0, 0.54)" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 496 496" >
<g>
	<g>
		<g>
...
<g>
        ...
        <ListItemText primary="ثبت نمره‌‌ها" />
      </ListItem>
      
      
      <ListItem button  component={Link} to="/sahand/teacher/dashboard/sendAssignment">
        <ListItemIcon>
         <Assignment color="rgba(0, 0, 0, 0.54)"/>
        </ListItemIcon>
        <ListItemText primary="ارسال تکلیف" />
      </ListItem>

      <ListItem button component={Link} to='/sahand/teacher/dashboard/attendance'>
        <ListItemIcon>
         <HowToReg color="rgba(0, 0, 0, 0.54)"/>
        </ListItemIcon>
        <ListItemText primary="حضور و غیاب" />
      </ListItem>

      <ListItem button component={Link} to='/sahand/teacher/dashboard/homeActivity'>
        <ListItemIcon>
         <HomeActivity color="rgba(0, 0, 0, 0.54)" />
        </ListItemIcon>
        <ListItemText primary="فعالیت در خانه" />
      </ListItem>

      <ListItem button component={Link} to='/sahand/teacher/dashboard/appointments'>
        <ListItemIcon>
        ...
        <ListItemText primary="ملاقات‌ها" />
      </ListItem>

    
      <ListItem button component={Link} to='/sahand/teacher/dashboard/encourages'>
        <ListItemIcon>
...
<ListItem button component={Link} to='/sahand/teacher/dashboard/news'>
        <ListItemIcon>
        <SvgIcon nativeColor="rgba(0, 0, 0, 0.54)" viewBox="0 0 1000 1000">
...
<ListItem button component={Link} to='/sahand/teacher/dashboard/gallery'>
        <ListItemIcon>
         <Gallery color="rgba(0, 0, 0, 0.54)"/>
        </ListItemIcon>
        <ListItemText primary="گالری" />
      </ListItem>

<ListItem button component={Link} to='/sahand/teacher/dashboard/messages'>
        <ListItemIcon>
...
<ListItem button component={Link} to='/sahand/teacher/dashboard/teacherTimeTable'>
        <ListItemIcon>
         <AvTimer color="rgba(0, 0, 0, 0.54)"/>
        </ListItemIcon>
        <ListItemText primary="برنامه کلاسی" />
      </ListItem>

 <ListItem button component={Link} to='/sahand/teacher/dashboard/calendar'>
        <ListItemIcon>
         <Calendar color="rgba(0, 0, 0, 0.54)"/>
        </ListItemIcon>
        <ListItemText primary="تقویم اجرایی" />
      </ListItem> 


<ListItem button component={Link} to='/sahand/teacher/dashboard/about'>
        <ListItemIcon>
         <School color="rgba(0, 0, 0, 0.54)"/>
        </ListItemIcon>
        <ListItemText primary="درباره مدرسه" />
      </ListItem>

<ListItem button component={Link} to='/sahand/teacher/dashboard/magazine'>
        <ListItemIcon>
      ...
      <ListItem button component={LogoutWrapper}>
        <ListItemIcon>
          <ExitToApp color="rgba(0, 0, 0, 0.54)"/>
        </ListItemIcon>
